...
import { QFLOW_DIR } from '@google/gemini-cli-core';
...
const USER_QFLOW_DIR = path.join(os.homedir(), QFLOW_DIR);
// Project-level .gemini directory in the workspace
const WORKSPACE_QFLOW_DIR = path.join(projectRoot, QFLOW_DIR);

// Telemetry artifacts are stored in a hashed directory under the user's ~/.qflow/tmp
export const OTEL_DIR = path.join(USER_QFLOW_DIR, 'tmp', projectHash, 'otel');
