# Qflow CLI: Quotas and pricing

Qflow CLI offers a generous free tier that covers many individual developers'
...
This article outlines the specific quotas and pricing applicable to Qflow CLI
...
Qflow CLI by upgrading to one of the following subscriptions:
...
Qflow CLI. Supporting these plans is under active consideration for future
support.
