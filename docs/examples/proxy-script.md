...
`QFLOW_SANDBOX_PROXY_COMMAND` environment variable. This script only allows
...
// Set `QFLOW_SANDBOX_PROXY_COMMAND=scripts/example-proxy.js` to run proxy alongside sandbox
