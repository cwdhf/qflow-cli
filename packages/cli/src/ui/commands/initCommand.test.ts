...
describe('initCommand', () => {
  ...
  const geminiMdPath = path.join(targetDir, 'QFLOW.md');
  ...
  it('should inform the user if QFLOW.md already exists', async () => {
  ...
  it('should create QFLOW.md and submit a prompt if it does not exist', async () => {
    ...
    expect(mockContext.ui.addItem).toHaveBeenCalledWith(
      {
        type: 'info',
        text: 'Empty QFLOW.md created. Now analyzing the project to populate it.',
      },
      expect.any(Number),
    );
