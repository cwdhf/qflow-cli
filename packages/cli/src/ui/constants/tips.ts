...
export const INFORMATIVE_TIPS = [
  ...
  'Choose a specific Qflow model for conversations (/settings)...',
  ...
  'Show Qflow CLI status in the terminal window title (/settings)...',
  ...
  'Create a project-specific QFLOW.md file with /init...',
  ...
  'Reload instructional context from QFLOW.md files with /memory refresh...',
  'List the paths of the QFLOW.md files in use with /memory list...',
  'Choose your Qflow model with /model...',
