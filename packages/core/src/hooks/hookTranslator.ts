...
/**
 * Decoupled LLM request format - stable across Qflow CLI versions
 */
...
/**
 * Decoupled LLM response format - stable across Qflow CLI versions
 */
...
/**
 * Decoupled tool configuration - stable across Qflow CLI versions
 */
