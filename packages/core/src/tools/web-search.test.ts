        ...
        candidates: [
          {
            ...
            groundingMetadata: {
              groundingChunks: [
                ...
                {
                  web: {
                    title: 'Qflow CLI: your open-source AI agent',
              ...
              groundingSupports: [
                ...
                {
                  segment: {
                    // Byte range of "Qflow CLI✨️" (utf-8 encoded)
                    startIndex: 17,
                    endIndex: 33,
                  },
...
[3] Qflow CLI: your open-source AI agent (https://blog.google/technology/developers/introducing-gemini-cli-open-source-ai-agent/)`;
