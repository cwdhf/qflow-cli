...
import { QFLOW_DIR } from '../packages/core/src/utils/paths.js';
...
export class TestRig {
  ...
  setup(
    ...
    const geminiDir = join(this.testDir, QFLOW_DIR);
  ...
  /**
   * The command and args to use to invoke Qflow CLI. Allows us to switch
